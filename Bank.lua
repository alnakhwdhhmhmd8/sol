...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n↤ جـاك ماعندها حساب بالبنك ","md",true)  
return false
end
...
send(msg.chat_id,msg.id, "↤ حوالة صادرة من بنك جـاك\n\n↤ المرسل ↤ "..news.."\n↤ الحساب رقم ↤ `"..cccc.."`\n↤ نوع البطاقة ↤ "..uuuu.."\n↤ المستلم ↤ "..newss.."\n↤ الحساب رقم ↤ `"..text.."`\n↤ نوع البطاقة ↤ "..fsvhh.."\n↤ خصمت 10% رسوم تحويل\n↤ المبلغ ↤ "..convert_mony.." ريال 💵","md",true)
send(fsvhhh,0, "• حوالة واردة من بنك جـاك\n\n↤ المرسل ↤ "..news.."\n↤ الحساب رقم ↤ `"..cccc.."`\n↤ نوع البطاقة ↤ "..uuuu.."\n↤ المبلغ ↤ "..convert_mony.." ريال 💵","md",true)
Redis:del(TheMero.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(TheMero.."transn" .. msg.sender_id.user_id)
else
send(msg.chat_id,msg.id, "↤ مافيه حساب بنكي كذا","md",true)
...
if Redis:sismember(TheMero.."booob",msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "• اهلا فيك بمزرعة جـاك :\n\n↤ المزروعات واسعارها :\n- بطاطا : 75 درهم 💵\n- بندوره : 100 درهم 💵\n- خس : 125 درهم 💵\n- خيار : 150 درهم 💵\n- جزر : 175 درهم 💵\n- فليفله : 200 درهم 💵\n- فريز : 300 درهم 💵\n- ذره : 400 درهم 💵\n- ثوم : 500 درهم 💵\n- فطر : 800 درهم 💵\n- شجره تفاح : 1000 درهم 💵\n- شجره عنب : 1250 درهم 💵\n-شجره زيتون : 1500 درهم 💵\n- شجره موز : 2000 درهم 💵\n- شجره مانجا : 3000 درهم 💵\n\n↤ مثال طريقة الزراعه : \n- زراعه بطاطا 10\n- زراعه شجر موز 15\n-","md",true)
else
send(msg.chat_id,msg.id, "↤ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n↤ جـاك ماعنده حساب بالبنك ","md",true)  
return false
end
if Redis:sismember(TheMero.."booob",Remsg.sender_id.user_id) then
ballanceed = Redis:get(TheMero.."boob"..Remsg.sender_id.user_id) or 0
